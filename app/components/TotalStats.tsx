            ...
            <h3 className='text-2xl ml-2 mt-2 font-bold'>Totalt</h3>
            {
                totalDebt || totalVolume || numberOfDrinks ? (
                    <div className='md:grid md:grid-cols-2 gap-4 w-full'>
                        {totalDebt > 0 && (
                            <div className='mb-2 bg-white shadow-md rounded-lg p-2 border border-grey'>
                    ...
                    <div className='flex items-center justify-between bg-white shadow-md rounded-lg p-2 mb-2 border border-grey'>
                        <h3 className='text-lg font-medium'>Ingen data än eller så har ingen en skuld. Strecka något.</h3>
                    </div>
                )
